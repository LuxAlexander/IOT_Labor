...
int main ()
{
    /*LED Color	Forward Voltage VfVf​	Current II	5V Supply (ΩΩ)	3.3V Supply (ΩΩ)
            Blue	2.5V @ 1mA	1mA	2.5kΩ	820Ω
            Green	2.4V @ 1mA	1mA	2.6kΩ	910Ω
            Red	1.8V @ 3mA	3mA	1.1kΩ	510Ω*/
